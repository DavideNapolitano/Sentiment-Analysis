...
tfidf_train=tfidf.fit_transform(X1_train)
tfidf_test=tfidf.transform(X1_test)
...
tfidf_ds_d=tfidf.fit_transform(list_rev)
tfidf_ds_e=tfidf.transform(list_rev_e)

clf_e=best.fit(tfidf_ds_d,y)
y_pred_EVAL=clf_e.predict(tfidf_ds_e)
